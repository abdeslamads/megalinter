...
- Linter versions upgrades (N)
  ...
  - [ruff-format](https://github.com/astral-sh/ruff) from 0.14.0 to **0.14.1** on 2025-10-17
  - [ruff](https://github.com/astral-sh/ruff) from 0.14.0 to **0.14.1** on 2025-10-17
  - [grype](https://github.com/anchore/grype) from 0.101.0 to **0.101.1** on 2025-10-17
  - [syft](https://github.com/anchore/syft) from 1.34.1 to **1.34.2** on 2025-10-17
  - [trufflehog](https://github.com/trufflesecurity/trufflehog) from 3.90.9 to **3.90.11** on 2025-10-17
  - [robocop](https://github.com/MarketSquare/robotframework-robocop) from 6.8.0 to **6.8.3** on 2025-10-17
<!-- linter-versions-end -->
